...
/* Command for C compiler:
   clang -c  -w  -I/usr/local/Cellar/nim/0.18.0_1/nim/lib -o <home>/Documents/Code/PolyGlot/NimPractice/test/nimcache/stdlib_math.o <home>/Documents/Code/PolyGlot/NimPractice/test/nimcache/stdlib_math.c */
